		...
		<div className="w-full h-full flex flex-col justify-between">
				...
				<tbody>
					{orders.map((order, index) => {
						return (
							<tr
								key={index}
								className="border-b hover:bg-blue-600 hover:text-white"
								onClick={() => {
							...
							>
								<td className="p-2.5">{order.orderID}</td>
								<td className="p-2.5">{order.email}</td>
								<td className="p-2.5">{order.name}</td>
								<td className="p-2.5">{order.address}</td>
								<td className="p-2.5">{order.phone}</td>
			...
			{popupVisible && clickedOrder && (
				<div className="fixed top-0 left-0 w-full h-full bg-[#00000050] flex justify-center items-center z-50">
					<div className="w-full max-w-2xl max-h-150 bg-white rounded-lg  p-6 relative shadow-xl">
                        {
						...
						{/* Close Button */}
						<button
							className="absolute w-7.5 h-7.5 bg-red-600 border-2 border-red-600 text-white -top-6.25 -right-6.25 rounded-full cursor-pointer hover:bg-transparent hover:text-red-600 z-50"
						...
						<div className="mb-6 space-y-1">
                            ...
                            <textarea
                                className="w-full h-12.5 p-2 border rounded mt-2"
                                value={orderNotes}
						...
						<div>
							...
							<div className="space-y-4 max-h-25 overflow-y-auto">
