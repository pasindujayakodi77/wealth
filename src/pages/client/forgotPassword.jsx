	...
	return (
		<div className="w-full h-full flex justify-center items-center text-secondary">
			{!emailSent&&<div className="bg-primary w-125 h-125 shadow-2xl flex flex-col items-center justify-center gap-5 rounded-[30px]">
				...
				/>
				<button onClick={sendOTP} className="w-87.5 h-10 bg-blue-500 rounded-xl text-white text-lg mt-5 hover:bg-blue-600 transition-all duration-300">
					Send OTP
				</button>
			</div>}
            {
                emailSent&& <div className="bg-primary w-125 h-125 shadow-2xl flex flex-col items-center justify-center gap-5 rounded-[30px]">
                    ...
                    />
                    <button onClick={resetPassword} className="w-87.5 h-10 bg-blue-500 rounded-xl text-white text-lg mt-5 hover:bg-blue-600 transition-all duration-300">
                        Reset Password
                    </button>
                </div>
            }
