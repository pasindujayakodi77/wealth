        ...
        <div className="w-full h-full">
            ...
            }
            {
                status == "success" && <div className="w-full h-full flex flex-row">
                    ...
                    <div className="w-[49%] h-full flex flex-col items-center pt-12.5">
                        ...
                        <div className="w-full flex flex-col items-center mt-5">
                            {
                                ...
                                <div>
                                    <span className="text-2xl font-semibold  line-through mr-5">{product.labelledPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span> 
                        ...
                        <div className="w-full flex flex-row justify-center items-center mt-5  gap-2.5">
                            ...
                            onClick={
                             ...
                             className="w-50 h-12.5 cursor-pointer rounded-xl shadow-2xl text-white bg-blue-900 border-[3px] border-blue-900 hover:bg-white hover:text-blue-900">Buy Now</button>
                            <button className="w-50 h-12.5 cursor-pointer rounded-xl shadow-2xl text-white bg-blue-600 border-[3px] border-blue-600 hover:bg-white hover:text-blue-600" onClick={
                                ()=>{
                                    addToCart(product,1)
